...
import useLogoutIfAccessDenied from '@specfocus/view-focus.auth/providers/useLogoutIfAccessDenied';
 ...
 * import { useDataProvider } from '@specfocus/view-focus.mui-demo';
 *
 * const PostList = () => {
