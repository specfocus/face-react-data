...
import { DeleteManyParams } from '../delete-many';
 ...
 *
 * import { useDeleteMany } from '@specfocus/view-focus.mui-demo';
 *
...
export interface UseDeleteManyMutateParams<RecordType extends Entity = any> {
  resource?: string;
  ids?: RecordType['id'][];
  meta?: any;
}
