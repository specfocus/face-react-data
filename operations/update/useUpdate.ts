...
import {
  MutateOptions,
  QueryKey, useMutation, UseMutationOptions,
 ...
 *
 * import { useUpdate } from '@specfocus/view-focus.mui-demo';
 *
...
export interface UseUpdateMutateParams<RecordType extends Entity = any> {
  resource?: string;
  id?: RecordType['id'];
