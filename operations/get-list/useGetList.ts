...
import { GetListParams, GetListResult } from '../get-list';
 ...
 * @example
 *
 * import { useGetList } from '@specfocus/view-focus.mui-demo';
 *
 * const LatestNews = () => {
 ...
 * };
 */
export const useGetList = <RecordType extends Entity = any>(
  resource: string,
