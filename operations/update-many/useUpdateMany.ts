...
import type { UpdateManyParams } from '../update-many';
 ...
 *
 * import { useUpdateMany } from '@specfocus/view-focus.mui-demo';
 *
...
export interface UseUpdateManyMutateParams<RecordType extends Entity = any> {
  resource?: string;
