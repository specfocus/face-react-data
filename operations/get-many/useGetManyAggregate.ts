...
import { Identifier, Entity } from '../../entities';
import { DataProvider } from '../../providers/DataProvider';
import { useDataProvider } from '../../providers/useDataProvider';
import { GetManyParams } from '../get-many';
 ...
 * @example
 *
 * import { useGetManyAggregate } from '@specfocus/view-focus.mui-demo';
 *
 ...
 * };
 */
export const useGetManyAggregate = <RecordType extends Entity = any>(
  resource: string,
